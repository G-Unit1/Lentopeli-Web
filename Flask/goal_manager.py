...
def goal_manager(player_name):
    ...
    player_id = cursor.cursor_fecth(sql__find_player_id)[0][0]
    ...
    continent_id = cursor.cursor_fecth(sql__check_continent_id)[0]
    ...
    if continent_id not in goals_reached:
        ...
        cursor.cursor_execute(sql__update_goals)
